...
### [▶&nbsp; Live demo](https://kube.straightarc.com) &nbsp;·&nbsp; [What's new (v1.8.1)](RELEASE-NOTES-v1.8.1.md) &nbsp;·&nbsp; [Report a bug](https://github.com/straightarctech/skyvirt-kubeui/issues) &nbsp;·&nbsp; [Contribute](CONTRIBUTING.md)
...
- **Certificate expiry** — server-side scan of your TLS secrets, flagging
  expired and soon-to-expire certificates before they page you.
- **Config drift** — see where live objects have diverged from their declared
...
- **Upgrade readiness** — scan manifests for deprecated / removed Kubernetes APIs
  before you bump the cluster version.
