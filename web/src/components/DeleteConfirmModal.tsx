              ...
              {isProtected && (
                <div className="flex items-center justify-between bg-red-500/10 border border-red-500/30 rounded px-4 py-3">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-red-400 text-sm font-medium">Protected</span>
                  </div>
                  <button
                    onClick={handleUnprotect}
                    disabled={togglingProtection}
                    className="px-3 py-1 text-xs rounded border border-red-500/50 text-red-400 hover:bg-red-500/20 transition-colors disabled:opacity-50"
                  >
