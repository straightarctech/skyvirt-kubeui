...
const Exposure = lazy(() => import("@/pages/networking/Exposure"));
...
const ClusterHealth = lazy(() => import("@/pages/observability/ClusterHealth"));
      ...
      <Suspense fallback={<PageLoader />}>
        <Routes>
          ...
          <Route element={<RequireAuth><Layout /></RequireAuth>}>
            ...
            <Route path="networking/exposure" element={<Exposure />} />
            ...
            <Route path="observability/health" element={<ClusterHealth />} />
