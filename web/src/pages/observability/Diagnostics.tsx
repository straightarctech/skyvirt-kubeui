            ...
            {checks.map((c) => (
              ...
              >
                <div className="mt-0.5 shrink-0">
                  {c.status === "ok" && (
                    <svg className="w-5 h-5 text-th-ok" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                  )}
                  {c.status === "warn" && (
                    <svg className="w-5 h-5 text-th-warn" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
