          ...
          <div className="bg-th-panel border border-th-line rounded-xl shadow-2xl w-full max-w-2xl max-h-[80vh] overflow-y-auto p-6 space-y-4" onClick={(e) => e.stopPropagation()}>
            ...
            {releaseValues && (
              <div>
                ...
                <pre className="bg-th-subtle border border-th-line rounded-lg p-3 text-xs text-th-body font-mono overflow-x-auto max-h-48 overflow-y-auto whitespace-pre-wrap">
                  {releaseValues}
                </pre>
              </div>
            )}
