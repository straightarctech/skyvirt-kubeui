...
import VeleroConsole from "@/components/VeleroConsole";
...
export default function Backup() {
  ...
  return (
    <div className="space-y-5 animate-fade-in">
      <h1 className="text-2xl font-bold text-th-heading">Backup &amp; Disaster Recovery</h1>

      <VeleroConsole />

      <div className="border-t border-th-line pt-4">
        <h2 className="text-sm font-semibold text-th-label">Quick manifest export</h2>
        <p className="mt-0.5 text-xs text-th-dim">
          Download resource manifests as YAML for GitOps or migration — a lightweight complement to Velero.
