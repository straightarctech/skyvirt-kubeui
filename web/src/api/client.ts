...
export async function getHelmReleaseValues(namespace: string, name: string): Promise<{ values: string }> {
  return request(`/namespaces/${namespace}/helm/releases/${name}/values`);
}
